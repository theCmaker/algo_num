...
% \lstinputlisting[style=customc, name=Structure de file, label=structfile, firstline=4, lastline=8, firstnumber=4]{file.h}
\newpage
\lstinputlisting[style=apercu, name=Arborescence des fichiers \lstinline"C" et \lstinline"makefile", label=arborescence]{arborescence}
  ...
  \chapter{Polynôme caractéristique}
	...
	\lstinputlisting[style=customc, firstline=9,lastline=59, firstnumber=9]{leverrier.c}
    \section{Méthode de Leverrier améliorée}
      \subsection{Présentation}
      \subsection{Programme}
	\lstinputlisting[style=customc, firstline=61,lastline=146, firstnumber=61]{leverrier.c}
