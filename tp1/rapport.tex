...
Votre choix : 
    ...
    Chaque fonction de résolution reçoit les matrices générées auparavant (juste après le choix de la méthode dans le menu) en arguments.
    \lstinputlisting[style=apercu, name=Arborescence]{arborescence}
