...
Votre choix : 
  ...
  \chapter{Méthodes itératives}
      On cherche à décomposer la matrice A en M et N tel que A = M-N.
  	\section{Méthode de Jacobi}
  	Le mystère de git pourrait être résolu incessamment sous peu à l'aide de la toute puissance de apt-get remove !!!!
  	lolilolmdptdfr, il y a trop de bruit en amphi.
  	  \subsection{Programme}
